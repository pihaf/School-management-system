...
CREATE TABLE `grades` (
  ...
  `component_score` float DEFAULT NULL,
  `midterm_score` float DEFAULT NULL,
  `finalterm_score` float DEFAULT NULL,
...
INSERT INTO `grades` VALUES (1,'21020223',583,8.5,7.8,9,8.76),(2,'0',1,9,8.2,8.8,8.84),(3,'0',2,7.5,8.6,9.2,8.46);
